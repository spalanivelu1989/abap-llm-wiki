...
// the one baked into NODES above: ⬇ Export layout downloads the current
// coordinates so they can be written into this file as the authored default.
// LAYOUT_STAMP is bumped whenever that happens, which retires every previously
// saved layout in every profile.
